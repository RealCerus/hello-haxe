...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public hx::Object
{
	...
	public:
		...
		static void makeBreak(::String secName);
		static ::Dynamic makeBreak_dyn();

		static ::String test( ::Dynamic i,::String s);
		static ::Dynamic test_dyn();

		static ::String hello(::String str);
		static ::Dynamic hello_dyn();

		static void print( ::Dynamic it);
		static ::Dynamic print_dyn();

		static void loops();
		static ::Dynamic loops_dyn();
